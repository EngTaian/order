...
@EnableJpaRepositories(basePackages = {
        "br.com.taian.order.repository"
})
@EnableTransactionManagement
@EnableSpringDataWebSupport
@EntityScan({"br.com.taian.order.model"})
public class PersistenceConfig {

    private static final String[] ENTITY_PACKAGES = {"br.com.taian.order.model"};
    ...
    DataSource dataSource(Environment env) {
        ...
        dataSourceConfig.setPoolName("pool-postgres-order");
